...
class MedicineScanController extends StateNotifier<AsyncValue<String?>> {
  ...
  void clearResult() => state = const AsyncValue.data(null);
}
...
- En "tipo" usa: pastilla, capsula, jarabe, gotas, inyeccion, crema, otro.
- En "dosis_unidad" usa: pildora, capsula, ml, cucharada, cucharadita, gotas, inyeccion, aplicacion, otro.
- "horarios_sugeridos" debe ser una lista de horas en formato HH:mm solo si aparecen horarios claros.
- Si solo aparece frecuencia como "cada 8 horas", escríbela en "frecuencia" y deja "horarios_sugeridos" vacío.
